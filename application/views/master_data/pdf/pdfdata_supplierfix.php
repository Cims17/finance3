...
private $widths;
  ...
  function NbLines($w,$txt)
  {
	...
	//   $this->AddPage();
	  ...
	  $this->SetX($left += 8); $this->Cell(53, $h, 'Nama Supplier', 1, 0, 'C',true);
	  $this->SetX($left += 53); $this->Cell(90, $h, 'Alamat', 1, 0, 'C',true);
	  $this->SetX($left += 90); $this->Cell(40, $h, 'Nomor Telepon', 1, 1, 'C',true);
	  //$this->Ln(20);

	  $this->SetFont('Arial','',10);
	  $this->SetWidths(array(8,53,90,40));
...
$this->myfpdf->Output('laporan-data-supplier-toko-anita ['.date('d-M-Y').'].pdf','I');
?>
